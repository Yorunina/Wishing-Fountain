...
import io.github.poisonsheep.wishingfountain.item.WishingFountainMapItem;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> WISHING_FOUNTAIN_MAP = ITEMS.register("wishing_fountain_map", WishingFountainMapItem::new);
}
